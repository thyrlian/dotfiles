...
alias brewery='type brew > /dev/null 2>&1 && ( brew update && brew upgrade && (brew info cask &>/dev/null && brew cask upgrade || true) && brew cleanup ) || ( echo "Homebrew is not installed :(" && exit 127 )'
